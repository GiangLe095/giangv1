  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen gap-12 py-8 ">
      ...
      <div className="flex flex-col items-center gap-4">
        <h1 className="text-3xl font-medium text-center">Bạn không có quyền truy cập tài nguyên này</h1>
        <p className="text-xl text-center ">Bạn đã cố truy cập tài nguyên này mà không có quyền truy cập.</p>
        <div style={{ marginTop: "12px" }}>
          <a
            href={DEFAULT_REDIRECT_AFTER_AUTH}
            style={{
              display: "inline-flex",
              alignItems: "center",
              padding: "8px 16px",
